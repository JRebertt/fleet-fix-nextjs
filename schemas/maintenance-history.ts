...
export const MaintenanceHistorySchema = z.object({
  ...
  vehicleId: z.string().uuid(), // Validar como string
  maintenanceDate: z.string(), // Validar como string
  ...
  createdAt: z.string(), // Validar como string
  updatedAt: z.string(), // Validar como string
})
